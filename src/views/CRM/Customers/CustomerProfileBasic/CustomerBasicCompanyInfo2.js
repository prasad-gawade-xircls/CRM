...
/* eslint-disable */
const CustomerBasicCompanyInfo2 = ({ allData }) => {
      ...
      {filteredData.map((form, i) => (
        <div key={i}>
          ...
          <Row>
            ...
            <Col md={6} lg={4} className="mt-0 mt-md-2">
            ...
            <Col md={6} lg={4} className="mt-0 mt-lg-2">
          ...
          <Row>
            <Col md={12} className="mt-2">
              <h4 className="mb-0">Parent Company Details {i + 1}</h4>
            </Col>
            <Col md={6} lg={4} className="mt-2">
              <label
                htmlFor="company-name"
            ...
            <div className="d-flex justify-content-between mt-2">
              ...
              <div>
                ...
                <button
                  ...
                  type="button"
                  onClick={() => {
                    const checkForm = validForm(AddCompanyValueToCheck, newCompany)
                    if (checkForm) {
                      setNewCompanyPage(2)
                    }
                  }
      ...
      <>
        <Offcanvas show={show} onHide={handleClose} placement="end">
          <Offcanvas.Header closeButton>
            <Offcanvas.Title>Add Customers</Offcanvas.Title>
          </Offcanvas.Header>
          <Offcanvas.Body>
            {SideForm}
          </Offcanvas.Body>
...
export default CustomerBasicCompanyInfo2
